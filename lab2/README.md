...
|---|---|
| Compilation | 10 |
| Stats output format correct | 10 |
| Insert: leaf visits > 0 | 10 |
| Insert: splits > 0 | 15 |
| Point lookup: leaf == 1 | 15 |
| Point lookup: internal ≥ 1 | 10 |
| Range scan: leaf ≥ 1 | 10 |
| Range scan: internal ≥ 1 | 10 |
| Small insert: correct behavior | 10 |
| **Total** | **100** |
